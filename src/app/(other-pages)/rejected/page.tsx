      ...
      <div className="mx-auto flex w-full max-w-[1180px] flex-col-reverse items-center justify-between text-center lg:flex-row lg:gap-5 lg:text-start 3xl:max-w-[1520px]">
        <div>
          ...
          <Text className="mb-6 max-w-[612px] text-sm leading-loose text-gray-500 md:mb-8 xl:mb-10 xl:text-base xl:leading-loose">
            Sorry you weren’t selected. You can reapply in 12 months. Please
            don’t attempt to reapply before 12 months with other credentials –
            it’s a violation of our Terms and can lead to you being permanently
            blocked.
          </Text>
        </div>
        <div className="relative">
          <Image
            src={welcome}
            alt="coming-soon"
            className="aspect-[4/3] max-w-[256px] sm:max-w-xs lg:max-w-lg 2xl:max-w-xl 3xl:max-w-[632px]"
          />
